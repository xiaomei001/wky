...
dpkg -i \
  /tmp/wky/libpcap0.8_1.10.1-4ubuntu1.22.04.1_armhf.deb \
  /tmp/wky/libpam0g_1.4.0-11ubuntu2.5_armhf.deb \
  /tmp/wky/libpam-modules_1.4.0-11ubuntu2.5_armhf.deb \
  /tmp/wky/ppp_2.4.9-1+1ubuntu3_armhf.deb \
  /tmp/wky/pptp-linux_1.10.0-1build3_armhf.deb
  else
    echo "跳过安装基础穿透软件"
  fi
else
